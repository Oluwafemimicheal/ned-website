    ...
    <div className='px-10 py-20 lg:px-10'>
      ...
      <div className='flex items-start gap-5 mt-10'>
        <div className='flex justify-between w-4xl'>
          ...
          <div className='w-12 h-12 flex justify-center items-center rounded-full bg-black shadow'><FaArrowRight color='white' /></div>
        </div>
        <div className='w-full lg:w-200 flex justify-end bg-green-500 relative'>
            <Slider/>
        </div>
      </div>
    </div>
